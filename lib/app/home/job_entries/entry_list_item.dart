  ...
  Widget _buildContents(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Text(dayOfWeek, style: TextStyle(fontSize: 18, color: Colors.grey)),
            SizedBox(width: 15),
            Text(startDate, style: TextStyle(fontSize: 18)),
        ...
        Row(children: [
          ...
          Expanded(child: Container()),
          Text(durationFormatted, style: TextStyle(fontSize: 16)),
        ]),
